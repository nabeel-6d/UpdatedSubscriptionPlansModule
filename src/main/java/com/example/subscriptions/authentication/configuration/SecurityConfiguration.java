package com.example.subscriptions.authentication.configuration;
...
import com.example.subscriptions.authentication.filter.JwtFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                .disable()
                .authorizeRequests()
                .antMatchers("/subscriber/user/authenticate")
                .permitAll()
                .anyRequest()
                .authenticated()
                .and()
